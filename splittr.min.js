...
e+"px",a.prevBar.style.top=a.prevBar.offsetTop-e+"px",a.style.top=a.offsetTop-e+"px",a.style.height=c+"px")}else{if(!a.next)throw Error("Splittr: Must have next panel (anchor prev)");d?(a.next.style.width=a.next.offsetWidth-e,a.next.style.left=a.next.offsetLeft+e,a.nextBar.style.left=a.nextBar.offsetLeft+e,a.style.width=c+"px"):(a.next.style.height=a.next.offsetHeight-e,a.next.style.top=a.next.offsetTop+e,a.nextBar.style.top=a.nextBar.offsetTop+e,a.style.height=c+"px")}window.splittr.util.dispatchSplitterMove(a.parentNode,
