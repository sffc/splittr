...
window.splittr.init=function(){var a=/^(horizontal|vertical) (static|dynamic) ((?:\d+ ?)+)$/;window.splittr.util.get(document,function(){var c=this.getAttribute("data-splittr");if(!c)return!1;var b=a.exec(c);if(!b)throw Error("Splittr: Invalid options string.  (Read '"+c+"')");var d="vertical"===b[1],e="dynamic"===b[2],h=b[3].split(" "),k=document.createElement("div");d?k.setAttribute("class","splittr-bar-container splittr-bar-container-vertical"):k.setAttribute("class","splittr-bar-container splittr-bar-container-horizontal");
var j=0,l=[],c=window.splittr.util.children(this,function(a){var b=parseInt(h[a])||0;this.collapsible=null!==this.getAttribute("data-splittr-collapsible");0<a&&(a=window.splittr.util.makeBar(d,e,j),k.appendChild(a),l.push(a),j+=window.splittr.barBreadth);d?(this.style.left=j+"px",this.style.width=b+"px"):(this.style.top=j+"px",this.style.height=b+"px");j+=b},!0);this.appendChild(k);b=c[c.length-1];d?(b.style.width="auto",b.style.right=0,b.style.width=b.offsetWidth+"px"):(b.style.height="auto",b.style.bottom=
0,b.style.height=b.offsetHeight+"px");for(b=l.length-1;0<=b;b--){var g=l[b],f=c[b],m=c[b+1];e&&(window.splittr.util.handleMouseEvents(g,f,m,d),f.collapsible&&g.addCollapse(!0,d,f,m),m.collapsible&&g.addCollapse(!1,d,f,m));f.next=m;m.prev=f;g.next=m;g.prev=f;f.nextBar=g;m.prevBar=g}},!1)};
...
a.prev,a.next);window.splittr.util.dispatchSplitterDone(a.parentNode,a.prev,a.next)};window.splittr.util={};window.splittr.util.copy=function(a){var c=[],b;for(b in a)a.hasOwnProperty(b)&&c.push(a[b]);return c};window.splittr.util.get=function(a,c,b){a=a.getElementsByTagName("*");b&&(a=window.splittr.util.copy(a));return window.splittr.util._elements(a,c)};window.splittr.util._elements=function(a,c){for(var b=[],d=0,e=0;e<a.length;e++){var h=a[e];1===h.nodeType&&(!c||!1!==c.call(h,d++))&&b.push(h)}return b};
window.splittr.util.children=function(a,c,b){a=a.childNodes;b&&(a=window.splittr.util.copy(a));return window.splittr.util._elements(a,c)};
